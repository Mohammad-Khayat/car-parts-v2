...
export default {
    ...
    categories: [
      {
        ...
        quantity: "35",
        image:
          "https://upload.wikimedia.org/wikipedia/commons/f/f0/BMW_S85B50_Engine.JPG",
      },
      {
        id: 2,
        name: "قطع دوزان",
  ...
  mutations: {
    ...
    Set_Category_Dto(state, payload) {
      if (payload) state.categoryDto = payload;
      else state.Set_Category_Dto = { name: "", image: null };
    },
  },
  actions: {
